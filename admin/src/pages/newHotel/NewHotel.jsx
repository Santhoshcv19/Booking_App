...
const NewHotel = ({ }) => {
  ...
  const { data, loading, error } = useFetch("https://booking-app-server-bdzt.onrender.com/api/rooms")
  ...
  const handleClick = async e =>{
    ...
    try{
      const list  = await Promise.all(Object.values(files).map( async(file)=>{
        ...
        const uploadRes = await axios.post("https://api.cloudinary.com/v1_1/dmvvo0g8g/image/upload",data);
